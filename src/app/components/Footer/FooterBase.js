...
export const FooterBase = async ({ t, lng }) => {
  ...
  return (
    <>
      <footer className="flex flex-row flex-wrap w-full justify-center items-center bg-[#4C051A] py-4 text-white">
      ...
      <div className="flex flex-row flex-wrap w-full justify-around py-4 bg-[#1A4693] text-white">
        <div>
