    ...
    >
      ...
      <div className="absolute inset-0 rounded overflow-hidden">
        <div className="absolute inset-0">
          <HeroBgImage
            image="https://psserviceimages.s3.us-east-2.amazonaws.com/dark/SISTEMAS/Hero.jpg"
            video="https://psserviceimages.s3.us-east-2.amazonaws.com/dark/SISTEMAS/datacenter+light.mp4"
          />
        </div>
      </div>
      ...
      <div className="relative z-10 flex flex-row flex-wrap justify-end items-center w-full my-8">
        ...
        <div className="flex flex-col flex-nowrap justify-center items-start w-[90vw] lg:w-[75vw] ">
          <h2 className="text-3xl lg:text-5xl text-[#0A2473] dark:text-white font-bold py-16 max-w-2xl text-shadow ">
            {t("Hero1")}
          </h2>
          <Link
            target="_blank"
