...
export default function Conocimiento({ t, documentos, lng }) {
  return (
    <>
      <div className="flex justify-center items-center md:items-start w-full md:w-[95vw]  ">
      ...
      <div className="flex justify-center items-center md:items-start w-full md:w-[95vw] ">
        <div className="flex flex-row flex-wrap justify-center md:justify-start m-4 md:p-0 items-center md:items-start w-full lg:p-0 lg:w-3/4 xl:w-1/2 bg-gradient-to-b from-[#C0D6D5] to-[#DEDEDE]  dark:bg-gradient-to-r dark:from-[#F8D3AE] dark:to-[#DDDDDD] rounded-3xl">
