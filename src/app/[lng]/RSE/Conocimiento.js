  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center lg:items-start w-full lg:w-[95vw] relative">
        ...
        <div className="flex flex-row flex-wrap justify-center lg:justify-start m-4 items-center lg:items-start w-full lg:p-0 lg:w-3/4 xl:w-1/2 bg-gradient-to-b from-[#C0D6D5] to-[#DEDEDE]  dark:bg-gradient-to-r dark:from-[#F8D3AE] dark:to-[#DDDDDD] rounded-3xl">
