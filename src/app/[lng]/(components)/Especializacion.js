export default function Especializacion({ t }) {
  return (
    ...
    >
      <div className="flex flex-col flex-nowrap w-full md:w-[95%] gap-8 items-start justify-start p-8">
        <div className="flex flex-row flex-wrap w-full gap-8 justify-center md:justify-start">
