export default function Unete({ t }) {
  return (
    ...
    >
      <div className="flex flex-row flex-wrap w-3/4 gap-8 items-start justify-start bg-[#155E75] dark:bg-gradient-to-r dark:from-[#10244A] dark:to-[#4D0519] rounded-xl py-8 px-8">
        <div className="flex flex-row flex-wrap justify-around items-stretch gap-8 w-0 md:w-80"></div>
