  ...
  return (
    <>
      <div className={`flex items-center w-full p-10 lg:p-0  `}>
        <div className="flex flex-col md:flex-row flex-nowrap md:flex-wrap  w-full justify-start lg:justify-start">
          <EspDataCenter
          ...
          {active !== "dataCenter" && (
            <div
              className={`text-[#0A2473] text-left dark:text-[#fff] flex flex-col-reverse lg:flex-row flex-nowrap lg:flex-wrap justify-center items-center lg:justify-start px-0 lg:px-8 mt-4 lg:mt-0 w-full md:w-[75vw] `}
            >
              {active === "" && (
              ...
              <div
                className={`flex flex-col md:flex-row flex-nowrap md:flex-wrap w-full  gap-4 lg:gap-8 mb-10 lg:mb-0   ${
                  active !== "dataCenter" || active !== ""
                    ? "duration-1000 items-start md:items-end"
              ...
              >
                ...
                />
                <div
                  className={`flex flex-col flex-nowrap gap-4  w-full md:w-auto ${
