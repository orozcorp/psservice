...
export default function Conocimiento({ t }) {
  ...
  return (
    <div className="relative flex justify-center items-center min-h-[60vh] w-[100vw] mt-16">
      ...
      <div className="z-40 flex flex-row mx-4 lg:mx-0 flex-wrap items-center w-full p-4lg:p-0 lg:w-3/4 xl:w-1/2 bg-gradient-to-b from-[#C0D6D5] to-[#DEDEDE]  dark:bg-gradient-to-r dark:from-[#F8D3AE] dark:to-[#DDDDDD]  rounded-3xl">
